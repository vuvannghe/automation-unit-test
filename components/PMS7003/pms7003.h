...
// define PMS7003 UART PORT and PINS config that respectively present the PMS uart port and PMS uart pins in menuconfig
#define PMS7003_UART_PORT CONFIG_PMS_UART_PORT
#define PMS7003_UART_TX_PIN CONFIG_PMS_PIN_TX
#define PMS7003_UART_RX_PIN CONFIG_PMS_PIN_RX
